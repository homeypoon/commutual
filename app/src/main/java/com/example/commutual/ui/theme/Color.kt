...
// graph surface
val md_theme_light_surfaceVariant = Color(0xFFF2FCFA)
val md_theme_light_onSurfaceVariant = Color(0xFF282B2E)
...
val md_theme_light_inversePrimary = Color(0xFF2FA2B1)
